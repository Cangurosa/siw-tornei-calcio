...
-- ARBITRI
INSERT INTO arbitro (id, nome, cognome, codice_arbitrale) VALUES (1, 'Gianluca', 'Rocchi', 'ROC-001');
INSERT INTO arbitro (id, nome, cognome, codice_arbitrale) VALUES (2, 'Daniele', 'Orsato', 'ORS-002');

-- PARTITE
INSERT INTO partita (id, data_ora, luogo, goals_home, goals_away, stato, torneo_id, squadra_home_id, squadra_away_id, arbitro_id) VALUES 
(1, '2026-04-20 15:00:00', 'Roma', 2, 1, 'CONCLUSA', 1, 1, 2, 1), 
(2, '2026-04-21 18:00:00', 'Milano', 0, 0, 'PROGRAMMATA', 1, 2, 3, 1), 
(3, '2026-04-22 20:45:00', 'Napoli', 3, 2, 'CONCLUSA', 1, 1, 3, 2);

-- Ripristino/allineamento delle sequenze PostgreSQL per evitare conflitti di ID (errore 500)
ALTER SEQUENCE squadra_seq RESTART WITH 10;
ALTER SEQUENCE torneo_seq RESTART WITH 10;
ALTER SEQUENCE giocatore_seq RESTART WITH 10;
